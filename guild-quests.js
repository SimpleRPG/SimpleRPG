...
window.GUILD_QUESTS = {
  warrior: [
    ...
    // ★ 戦士ギルドの転生依頼（戦闘転生 1 回）
    {
      ...
      desc: "戦闘転生を 1 回行う。",
      fameReward: 20,
      hint: "転生時に「戦闘転生」を選んで 1 度転生すると達成される。"
    },
    // ★ 職業解放クエスト（戦士ギルド：上位職用の枠だけ残す）
    {
      id: "warrior_job_unlock_1",
      name: "特別訓練：戦士の極意",
      desc: "戦士ギルド推奨の高難度訓練をこなす。（内容は後で詰める）",
      fameReward: 0,
      hint: "詳細な条件は後で実装予定。",
      minRank: 1,
      type: "job_unlock",
  ...
  mage: [
    ...
    // ★ 職業解放クエスト（魔法ギルド）
    {
      ...
      name: "特別訓練：魔導の極意",
      desc: "魔法ギルド推奨の高難度訓練をこなす。（内容は後で詰める）",
      fameReward: 0,
      hint: "詳細な条件は後で実装予定。",
      minRank: 1,
      type: "job_unlock",
  ...
  tamer: [
    ...
    // ★ 職業解放クエスト（動物使いギルド）
    {
      ...
      name: "特別訓練：獣と歩む者",
      desc: "動物使いギルド推奨の高難度訓練をこなす。（内容は後で詰める）",
      fameReward: 0,
      hint: "詳細な条件は後で実装予定。",
      minRank: 1,
      type: "job_unlock",
  ...
  smith: [
    ...
    // ★ 職業解放クエスト（鍛冶ギルド：鍛冶職人 or 武具使い を選択式で解放）
    {
      id: "smith_job_unlock_1",
      name: "特別訓練：鍛冶の極意",
      desc: "鍛冶ギルド推奨の高難度訓練をこなす。（内容は後で詰める）",
      fameReward: 0,
      hint: "詳細な条件は後で実装予定。",
      minRank: 1,
      type: "job_unlock",
  ...
  alchemist: [
    ...
    // ★ 職業解放クエスト（錬金ギルド：錬金術師 or 道具使い を選択式）
    {
      id: "alch_job_unlock_1",
      name: "特別訓練：錬金の極意",
      desc: "錬金ギルド推奨の高難度訓練をこなす。（内容は後で詰める）",
      fameReward: 0,
      hint: "詳細な条件は後で実装予定。",
      minRank: 1,
      type: "job_unlock",
  ...
  cooking: [
    ...
    // ★ 職業解放クエスト（料理ギルド：料理人 or 貪食家 を選択式）
    {
      id: "cooking_job_unlock_1",
      name: "特別訓練：料理の極意",
      desc: "料理ギルド推奨の高難度訓練をこなす。（内容は後で詰める）",
      fameReward: 0,
      hint: "詳細な条件は後で実装予定。",
      minRank: 1,
      type: "job_unlock",
  ...
  gather: [
    ...
    // ★ 職業解放クエスト（採取ギルド：採集士 or 採取監督官 を選択式）
    {
      id: "gather_job_unlock_1",
      name: "特別訓練：採取の極意",
      desc: "採取ギルド推奨の高難度訓練をこなす。（内容は後で詰める）",
      fameReward: 0,
      hint: "詳細な条件は後で実装予定。",
      minRank: 1,
      type: "job_unlock",
  ...
  food: [
    ...
    // ★ 職業解放クエスト（食材ギルド：狩猟師 / 漁師 / 農夫 を選択式）
    {
      id: "food_job_unlock_1",
      name: "特別訓練：食材の極意",
      desc: "食材ギルド推奨の高難度訓練をこなす。（内容は後で詰める）",
      fameReward: 0,
      hint: "詳細な条件は後で実装予定。",
      minRank: 1,
      type: "job_unlock",
